...
conn = pymongo.MongoClient('mongodb://18.219.250.177')
...
for i,label in enumerate(labels) :
  ...
  for blog in crawled_blogs :
    ...
    # 불필요한 처음 데이터 제거
    start_100 = blog['text'][100:]

    # 불필요한 공백 문자 제거
    replace_tab = start_100.replace('\t','')
    replace_enter = start_100.replace('\n','')
